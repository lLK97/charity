  ...
  return (
    <div className={styles.wrapperAddCampaign}>
      ...
      <Form>
        <FormGroup>
          <Label>Tiêu đề</Label>
          <Input placeholder="Tiêu đề" name="title" value={title} onChange={(e) => settitle(e.value)} />
        </FormGroup>
        <FormGroup>
          <Label>Ngày bắt đầu</Label>
          <Input placeholder="Ngày bắt đầu" name="dateStart" type="datetime" value={startdate} onChange={(e) => setstartdate(e.value)} />
        </FormGroup>
        <FormGroup>
          <Label>Ngày kết thúc</Label>
          <Input placeholder="Ngày kết thúc" name="dateEnd" type="datetime" value={enddate} onChange={(e) => setenddate(e.value)} />
        </FormGroup>
        <FormGroup>
        ...
        <FormGroup>
          ...
          <Input placeholder="300.000.000VND" name="target" type="text" value={amount} onChange={(e) => setamount(e.value)} />
        </FormGroup>
        <FormGroup>
        ...
        <FormGroup>
          ...
          <Input type="file" name="imageData" value={imageData} onchnage={(e) => setimageData(e.value)} />
        </FormGroup>
